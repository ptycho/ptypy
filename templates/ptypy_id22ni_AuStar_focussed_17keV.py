...
p.model.xy.dr = 250e-9                             # (26) round,round_roi :width of shell
...
p.model.xy.lx = 4e-6                            # (29) round_roi: Width of ROI
p.model.xy.ly = 4e-6                            # (30) round_roi: Height of ROI
...
p.model.illumination.aperture_type = "rect"       # (41) type of aperture: use 
p.model.illumination.aperture_size = 35e-6        # (42) aperture diameter (meter)
...
p.model.illumination.prop_dist = 1.4e-3           # (45) focus: propagation distance (meter) from focus. parallel: propagation distance (meter) from aperture 
...
p.model.illumination.photons = 3e7                # (49) number of photons in illumination
p.model.illumination.probe = None                 # (50) override if not None

p.model.sample = u.Param()
p.model.sample.source = u.xradia_star((1000,1000),minfeature=3,contrast=0.)# (52) 'diffraction', None, path to a file or nd-array 
...
p.simulation.detector = 'FRELON_TAPER' #'PILATUS_300K' #None #
...
#p.model.coherence.Nprobe_modes = 4
