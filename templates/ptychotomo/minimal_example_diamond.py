...
# Load probe
probe = np.load("./diamond_probe.npy")
...
sim.illumination.model = probe
sim.illumination.photons = int(1e9)
sim.illumination.aperture = None
...
scan.illumination.model = probe
scan.illumination.photons = 1e9
scan.illumination.aperture = None
