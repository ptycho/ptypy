...
p.model.geometry.z = 7.5                        # (19) distance from object to screen
p.model.geometry.psize_det = 55e-5                 # (20) Pixel size in Detector plane
p.model.geometry.psize_sam = None                 # (21) Pixel size in Sample plane
p.model.geometry.N = 512                         # (22) Number of detector pixels
...
p.model.illumination.probe_type = "focus"         # (37) 'focus' or 'parallel'
...
p.model.illumination.phase_noise_rms = 8.0        # (39) phase noise amplitude on incoming wave before aperture 
p.model.illumination.phase_noise_mfs = 10.0        # (40) phase noise minimum feature size on incoming wave before aperture 
p.model.illumination.aperture_type = "circ"       # (41) type of aperture: use 
p.model.illumination.aperture_size = 200e-6        # (42) aperture diameter (meter)
...
p.model.illumination.prop_dist = 5e-3           # (45) focus: propagation distance (meter) from focus. parallel: propagation distance (meter) from aperture 
p.model.illumination.UseConjugate = False         # (46) use the conjugate of the probe instef of the probe
p.model.illumination.antialiasing = 1.0           # (47) antialiasing factor used when generating the probe
...
s1.preparation.generic.rebin = 1
s1.preparation.generic.roi = 512
s1.preparation.generic.orientation = (True,True,True)

s1.preparation.type = "plugin"
s1.preparation.plugin = u.Param()
s1.preparation.plugin.file = './myscan.py'
s1.preparation.plugin.classname = None

plugin_pars = u.Param()
plugin_pars.base_path = '/home/thibault/science/experiments/I13_ptychotomo_01_2015/'
plugin_pars.scan_number = 39424
plugin_pars.flat_number = None
plugin_pars.dark_number = None
plugin_pars.mask_file = None
plugin_pars.detector_name = 'merlin_sw_hdf'

s1.preparation.plugin.pars = plugin_pars
