...
if __name__ == "__main__":
    ...
    # attach a reconstruction engine
    p.engines = u.Param()
    ...
    #p.engines.engine00.intensity_renormalization = None # turn off likelihood scaling
    p.engines.engine00.all_line_coeffs = True # use all polynomial coefficients in linesearch
