...
p.scans.I08.data.num_frames = 1000 # real is 50000
p.scans.I08.data.save = None

p.scans.I08.illumination = u.Param()
p.scans.I08.coherence = u.Param(num_probe_modes=1)
...
p.scans.I08.data.density = 0.1
# total number of photon in empty beam
p.scans.I08.data.photons = 1e8
# Gaussian FWHM of possible detector blurring
p.scans.I08.data.psf = 0.
...
p.engines.engine01.numiter_contiguous = 1
p.engines.engine01.probe_support = 0.9
