...
#NEXUS_PATHS.motors = ['t1_sy', 't1_sz']
NEXUS_PATHS.motors = ['lab_sy', 'lab_sx']
...
class I13Scan(PtyScan):
    ...
    def __init__(self, pars=None, **kwargs):
        ...
        if parallel.master:
            instrument = io.h5read(self.data_file,
                                   NEXUS_PATHS.instrument % self.info.recipe)[NEXUS_PATHS.instrument % self.info.recipe]
...
# #                 detector_name = self.info.recipe.detector_name
    ...
    def load_positions(self):
        ...
        instrument = h5.File(self.data_file)[NEXUS_PATHS.instrument % self.info.recipe]
        motor_positions = []
        i=0
