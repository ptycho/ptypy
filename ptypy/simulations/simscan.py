...
defaults_tree['scandata'].add_child(u.descriptor.EvalDescriptor('SimScan3D'))
defaults_tree['scandata.SimScan3D'].add_child(illumination_desc, copy=True)
