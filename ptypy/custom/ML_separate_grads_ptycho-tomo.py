...
class MLPtychoTomo(PositionCorrectionEngine):
    ...
    def engine_initialize(self):
        ...
        self.rho_grad = np.array((pshape, pshape, pshape))       # self.ob.copy(self.ob.ID + '_grad', fill=0.)
        self.rho_grad_new = np.array((pshape, pshape, pshape))   # self.ob.copy(self.ob.ID + '_grad_new', fill=0.)
        self.rho_h = np.array((pshape, pshape, pshape))          # self.ob.copy(self.ob.ID + '_h', fill=0.)
