...
from ..core.manager import Full, Vanilla, Bragg3dModel, BlockVanilla, BlockFull, BlockFull3D
...
class _ProjectionEngine(PositionCorrectionEngine):
    ...
    SUPPORTED_MODELS = [Full, Vanilla, Bragg3dModel, BlockVanilla, BlockFull, BlockFull3D]
