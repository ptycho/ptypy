...
DEFAULT = TreeDict(
    ...
    subpix_start=0,
    # 'fourier','linear' subpixel interpolation or None for no interpolation
    subpix='linear',
    ...
    obj_smooth_std=20,
    # None or float, Pixel radius around optical axes that
    # the probe mass center must reside in
    probe_center_tol=None,
)

DEFAULT_iter_info = TreeDict(
    'DEFAULT_iter_info',
    iteration=0,
    iterations=0,
    engine='None',
