...
class _ProjectionEngine_pycuda(projectional_pycuda_nostream._ProjectionEngine_pycuda_nostream):
    ...
    def engine_prepare(self):
        ...
        super(projectional_pycuda_nostream._ProjectionEngine_pycuda, self).engine_prepare()
