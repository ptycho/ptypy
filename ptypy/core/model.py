...
class BasicSharingModel(object):
    ...
    def __init__(self,sharing_dct, scan_per_probe, scan_per_object, Npts=None):
        ...
        if scan_per_probe == 0:
            ...
            logger.info('Model: sharing probe between scans (one new probe every %d scan)' % self.scan_per_probe)
        else:
    ...
    def __call__(self, scan_label, diff_index):
        """
        Return probe and object ids for a given scan and diffraction pattern index.
